...
F.StrictMode = ic;
F.Suspense = fc;
F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = gc;
F.act = es;
 ...
 */ (function (e) {
  ...
  function r(C) {
    ...
    if (T !== L) {
      C[0] = T;
      e: for (var X = 0, b = C.length, nr = b >>> 1; X < nr; ) {
        var kt = 2 * (X + 1) - 1,
          Sl = C[kt],
          xt = kt + 1,
          rr = C[xt];
        if (0 > l(Sl, T))
          xt < b && 0 > l(rr, Sl)
            ? ((C[X] = rr), (C[xt] = T), (X = xt))
            : ((C[X] = Sl), (C[kt] = T), (X = kt));
        else if (xt < b && 0 > l(rr, T)) (C[X] = rr), (C[xt] = T), (X = xt);
        else break e;
      }
    }
    return L;
  ...
  function v(C) {
    if (((S = !1), d(C), !k))
      if (n(s) !== null) (k = !0), kl(x);
      else {
        var L = n(c);
        L !== null && xl(v, L.startTime - C);
      }
  }
  function x(C, L) {
    ...
    try {
      for (
        d(L), h = n(s);
        h !== null && (!(h.expirationTime > L) || (C && !z()));

      ) {
        var X = h.callback;
        if (typeof X == "function") {
          (h.callback = null), (p = h.priorityLevel);
          var b = X(h.expirationTime <= L);
          (L = e.unstable_now()),
      ...
      if (h !== null) var nr = !0;
        ...
        var kt = n(c);
        kt !== null && xl(v, kt.startTime - L), (nr = !1);
      }
      return nr;
    } finally {
      (h = null), (p = T), (g = !1);
      ...
      return (
        ...
        T > X
          ? ((C.sortIndex = T),
            ...
            n(s) === null &&
              C === n(c) &&
              (S ? (f(P), (P = -1)) : (S = !0), xl(v, T - X)))
          : ((C.sortIndex = b), t(s, C), k || g || ((k = !0), kl(x))),
        C
      );
    }),
...
function gs() {
  if (Jt) {
    var e = Jt,
      t = qt;
    if (((qt = Jt = null), Ki(e), t)) for (e = 0; e < t.length; e++) Ki(t[e]);
  }
}
function ws(e, t) {
  return e(t);
...
function $c(e, t, n, r, l, o, i, u, s) {
  (_n = !1), (Rr = null), Dc.apply(Ic, arguments);
}
...
var Ns = Se.unstable_scheduleCallback,
  ...
  Bc = Se.unstable_shouldYield,
  Vc = Se.unstable_requestPaint,
  G = Se.unstable_now,
  Hc = Se.unstable_getCurrentPriorityLevel,
  bo = Se.unstable_ImmediatePriority,
  _s = Se.unstable_UserBlockingPriority,
  Dr = Se.unstable_NormalPriority,
  Wc = Se.unstable_LowPriority,
...
function vn(e, t) {
  e.blockedOn === t &&
    ...
    po ||
      ((po = !0),
      Se.unstable_scheduleCallback(Se.unstable_NormalPriority, ef)));
}
function Un(e) {
  function t(l) {
    return vn(l, e);
  ...
  for (; 0 < rt.length && ((n = rt[0]), n.blockedOn === null); )
    Rs(n), n.blockedOn === null && rt.shift();
}
...
function ni(e, t, n, r) {
  if ($r) {
    var l = ho(e, t, n, r);
    if (l === null) $l(e, t, r, Ur, n), Gi(e, r);
    else if (bc(l, e, t, n, r)) r.stopPropagation();
    else if ((Gi(e, r), t & 4 && -1 < qc.indexOf(e))) {
      for (; l !== null; ) {
        var o = er(l);
        if (
          (o !== null && Ls(o),
...
var Ur = null;
function ho(e, t, n, r) {
  if (((Ur = null), (e = qo(r)), (e = Ct(e)), e !== null))
...
var fn = {
  ...
  ol = K({}, bn, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== yn &&
            (yn && e.type === "mousemove"
              ? ((jl = e.screenX - yn.screenX), (Ll = e.screenY - yn.screenY))
              : (Ll = jl = 0),
            (yn = e)),
          jl);
    },
  ...
  qi = Ce(ol),
  lf = K({}, ol, { dataTransfer: 0 }),
  of = Ce(lf),
  uf = K({}, bn, { relatedTarget: 0 }),
  Ml = Ce(uf),
  sf = K({}, fn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = Ce(sf),
  cf = K({}, fn, {
...
var yf = K({}, bn, {
  ...
  xf = Ce(kf),
  Sf = K({}, fn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = Ce(Sf),
  Cf = K({}, ol, {
    deltaX: function (e) {
  ...
  Nf = Ce(Cf),
  _f = [9, 13, 27, 32],
  ii = Xe && "CompositionEvent" in window,
  Pn = null;
Xe && "documentMode" in document && (Pn = document.documentMode);
var Pf = Xe && "TextEvent" in window && !Pn,
  Is = Xe && (!ii || (Pn && 8 < Pn && 11 >= Pn)),
  tu = " ",
  nu = !1;
function $s(e, t) {
  switch (e) {
...
function jf(e, t) {
  if (At)
    return e === "compositionend" || (!ii && $s(e, t))
      ? ((e = Ds()), (Cr = ri = ot = null), (At = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function ou() {
  zn && (zn.detachEvent("onpropertychange", Vs), (An = zn = null));
}
function Vs(e) {
  if (e.propertyName === "value" && il(An)) {
    var t = [];
    As(t, An, e, qo(e)), xs(Mf, t);
  }
}
function Ff(e, t, n) {
  e === "focusin"
    ? (ou(), (zn = t), (An = n), zn.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ou();
}
function Rf(e) {
...
var Ie = typeof Object.is == "function" ? Object.is : If;
function Bn(e, t) {
  if (Ie(e, t)) return !0;
...
yt(Ks, "onAnimationEnd");
yt(Ys, "onAnimationIteration");
yt(Xs, "onAnimationStart");
yt("dblclick", "onDoubleClick");
yt("focusin", "onFocus");
yt("focusout", "onBlur");
yt(Gs, "onTransitionEnd");
...
var Cn =
  ...
  Vf = new Set("cancel close invalid load scroll toggle".split(" ").concat(Cn));
function cu(e, t, n) {
  ...
  xs(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Dn(a, f)), v != null && S.push(Hn(a, v, d)))),
            $)
          )
            break;
          a = a.return;
        ...
        0 < S.length &&
          ((p = new g(p, k, null, n, m)), h.push({ event: p, listeners: S }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (S = g, f = k, a = 0, d = S; d; d = It(d)) a++;
...
var dn = Math.random().toString(36).slice(2),
  ...
  xo = "__reactEvents$" + dn,
  Xf = "__reactListeners$" + dn,
  Gf = "__reactHandles$" + dn;
function Ct(e) {
  var t = e[Ae];
  if (t) return t;
...
function mu(e, t, n) {
  if (ae.current !== vt) throw Error(y(168));
  U(ae, t), U(ve, n);
}
function bs(e, t, n) {
  var r = e.stateNode;
...
function wt() {
  if (!Al && We !== null) {
    ...
    try {
      ...
      throw (We !== null && (We = We.slice(e + 1)), Ns(bo, wt), l);
    } finally {
      (I = t), (Al = !1);
    }
  }
...
var Qt = [],
  ...
  Ke = "";
function St(e, t) {
  (Qt[Kt++] = Qr), (Qt[Kt++] = Wr), (Wr = e), (Qr = t);
}
function ta(e, t, n) {
  (Ne[_e++] = Qe), (Ne[_e++] = Ke), (Ne[_e++] = Lt), (Lt = e);
  var r = Qe;
  e = Ke;
  var l = 32 - Oe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function si(e) {
  e.return !== null && (St(e, 1), ta(e, 1, 0));
}
function ai(e) {
  for (; e === Wr; )
    (Wr = Qt[--Kt]), (Qt[Kt] = null), (Qr = Qt[--Kt]), (Qt[Kt] = null);
  for (; e === Lt; )
    (Lt = Ne[--_e]),
      (Ne[_e] = null),
      (Ke = Ne[--_e]),
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (xe = e), (ke = ct(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Lt !== null ? { id: Qe, overflow: Ke } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function mr(e) {
  ...
  if (
    ...
    for (; t; ) na(e, t), (t = ct(t.nextSibling));
  }
  if ((gu(e), e.tag === 13)) {
  ...
  } else ke = xe ? ct(e.stateNode.nextSibling) : null;
  return !0;
}
function ra() {
  for (var e = ke; e; ) e = ct(e.nextSibling);
}
function ln() {
  (ke = xe = null), (V = !1);
}
...
var Jf = qe.ReactCurrentBatchConfig;
function gn(e, t, n) {
  if (
...
function la(e) {
  ...
  function m(f, a, d, v, x) {
    return a === null || a.tag !== 7
      ? ((a = zt(d, f.mode, v, x)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function h(f, a, d) {
  ...
  function p(f, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (Sn(d) || pn(d)) return x !== null ? null : m(f, a, d, v, null);
      vr(f, d);
    }
    return null;
  }
  function g(f, a, d, v, x) {
    ...
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        ...
        case tt:
          var N = v._init;
          return g(f, a, d, N(v._payload), x);
      }
      if (Sn(v) || pn(v)) return (f = f.get(d) || null), m(a, f, v, x, null);
      vr(a, v);
    }
    return null;
  }
  function k(f, a, d, v) {
    for (
      var x = null, N = null, _ = a, P = (a = 0), H = null;
      _ !== null && P < d.length;
      P++
    ) {
    ...
    if (P === d.length) return n(f, _), V && St(f, P), x;
    if (_ === null) {
      for (; P < d.length; P++)
        (_ = h(f, d[P], v)),
          _ !== null &&
            ((a = o(_, a, P)), N === null ? (x = _) : (N.sibling = _), (N = _));
      return V && St(f, P), x;
    }
  ...
  function S(f, a, d, v) {
    ...
    for (
      var N = (x = null), _ = a, P = (a = 0), H = null, M = d.next();
      _ !== null && !M.done;
      P++, M = d.next()
    ) {
      _.index > P ? ((H = _), (_ = null)) : (H = _.sibling);
      var z = p(f, _, M.value, v);
      if (z === null) {
        _ === null && (_ = H);
        break;
      }
    ...
    if (M.done) return n(f, _), V && St(f, P), x;
    if (_ === null) {
      for (; !M.done; P++, M = d.next())
        (M = h(f, M.value, v)),
          M !== null &&
            ((a = o(M, a, P)), N === null ? (x = M) : (N.sibling = M), (N = M));
      return V && St(f, P), x;
    }
...
function ki(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Pr.current = e === null || e.memoizedState === null ? nd : rd),
    (e = n(r, l)),
    Ln)
  ) {
    o = 0;
...
function Hl(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (o = l.lane), (Q.lanes |= o), (Tt |= o), (l = l.next);
    while (l !== e);
...
function cl(e, t, n, r) {
  ...
  (Q.flags |= e), (l.memoizedState = Gn(1 | t, n, o, r));
}
function Eu(e, t) {
...
function Ea(e, t, n) {
  return Mt & 21
    ? (Ie(n, t) || ((n = zs()), (Q.lanes |= n), (Tt |= n), (e.baseState = !0)),
      t)
...
function td(e, t, n) {
  ...
  if (Na(e)) _a(t, l);
    ...
    (n = ia(e, t, l, r)),
      n !== null && ((l = fe()), De(n, e, r, l), Pa(n, t, r));
  }
}
function Na(e) {
  var t = e.alternate;
...
function Po(e, t, n, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = je(o))
    : ((o = ye(t) ? jt : ae.current), (l.context = rn(e, o))),
  ...
  return (
    ...
    e !== null && !me
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Je(e, t, l))
      : (V && n && si(t), (t.flags |= 1), ce(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !me
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Je(e, t, l))
      : (V && r && si(t), (t.flags |= 1), ce(e, t, n, l), t.child)
  );
}
function Mu(e, t, n, r, l) {
  ...
  if ((en(t, l), t.stateNode === null))
    jr(e, t), za(t, n, r), Po(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
...
function Lo(e, t, n, r, l, o) {
  Fa(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && vu(t, n, !1), Je(e, t, o);
...
function Tu(e, t, n, r, l) {
  return ln(), ci(l), (t.flags |= 256), ce(e, t, n, r), t.child;
}
...
function ud(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Ql(Error(y(422)))), yr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (((u = (i & e.childLanes) !== 0), me || u)) {
    ...
    return Li(), (r = Ql(Error(y(421)))), yr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((ai(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (mr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Re !== null && (Bo(Re), (Re = null)))),
        Fo(e, t),
        ue(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = _t(Ve.current)), mr(t))) {
          (r = t.stateNode), (n = t.type);
          var o = t.memoizedProps;
          switch (((r[Ae] = t), (r[Wn] = o), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Ua(e, t, e.memoizedProps, r);
        ...
        if (((n = _t(Kn.current)), _t(Ve.current), mr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ae] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || W.current & 1 ? q === 0 && (q = 3) : Li())),
          t.updateQueue !== null && (t.flags |= 4),
          ue(t),
          null);
    case 4:
      return (
        un(), Fo(e, t), e === null && Vn(t.stateNode.containerInfo), ue(t), null
      );
    case 10:
    ...
    case 17:
      return ye(t.type) && Vr(), ue(t), null;
    case 19:
      if ((B(W), (o = t.memoizedState), o === null)) return ue(t), null;
...
function dd(e, t) {
  ...
  for (go = { focusedElem: e, selectionRange: n }, $r = !1, E = t; E !== null; )
...
function Aa(e) {
  ...
  t !== null && ((e.alternate = null), Aa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ae], delete t[Wn], delete t[xo], delete t[Xf], delete t[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Va(e, t, n) {
  ...
  switch (n.tag) {
    ...
    case 22:
      n.mode & 1
        ? ((se = (r = se) || n.memoizedState !== null), et(e, t, n), (se = r))
        : et(e, t, n);
      break;
    default:
      et(e, t, n);
...
function Ha(e, t) {
  ...
  switch (e.tag) {
    ...
    case 3:
      if (
        (Me(t, e), $e(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          Un(t.containerInfo);
        } catch (S) {
...
function De(e, t, n, r) {
  if (50 < Fn) throw ((Fn = 0), (Uo = null), Error(y(185)));
  qn(e, n, r),
    (!(R & 2) || e !== ne) &&
      (e === ne && (!(R & 2) && (pl |= n), q === 4 && lt(e, le)),
      ge(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((an = G() + 500), al && wt()));
}
function ge(e, t) {
  var n = e.callbackNode;
  Zc(e, t);
  var r = Ir(e, e === ne ? le : 0);
  if (r === 0)
...
function Qa(e, t) {
  if (((Lr = -1), (Mr = 0), R & 6)) throw Error(y(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = tl(e, r);
    ...
    R |= 2;
    var o = Ya();
    (ne !== e || le !== t) && ((He = null), (an = G() + 500), Pt(e, t));
    do
      try {
        yd();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Zn), Pt(e, 0), lt(e, r), ge(e, G()), n);
    if (t === 6) lt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (lt(e, r), (r & 130023424) === r && ((t = Pi + 500 - G()), 10 < t))
          ) {
            if (Ir(e, 0) !== 0) break;
            ...
            e.timeoutHandle = ko(Et.bind(null, e, he, He), t);
            break;
          }
          Et(e, he, He);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = ko(Et.bind(null, e, he, He), r);
            break;
          }
          Et(e, he, He);
          break;
...
function Au(e) {
  ...
  if (n === 1) throw ((n = Zn), Pt(e, 0), lt(e, t), ge(e, G()), n);
...
function Ft(e) {
  ...
  try {
    ...
    (I = r), (ze.transition = n), (R = t), !(R & 6) && wt();
  }
}
function ji() {
  (we = Gt.current), B(Gt);
...
function Li() {
  (q === 0 || q === 3 || q === 2) && (q = 4),
    ne === null || (!(Tt & 268435455) && !(pl & 268435455)) || lt(ne, le);
}
function tl(e, t) {
  var n = R;
  R |= 2;
  var r = Ya();
  (ne !== e || le !== t) && ((He = null), Pt(e, t));
  do
    try {
      vd();
      break;
  ...
  while (!0);
  if ((di(), (R = n), (qr.current = r), Z !== null)) throw Error(y(261));
...
function Et(e, t, n) {
  var r = I,
    l = ze.transition;
  try {
    (ze.transition = null), (I = 1), gd(e, t, n, r);
  } finally {
    (ze.transition = l), (I = r);
  }
  return null;
  ...
  if (it !== null) {
    ...
    try {
      if (((ze.transition = null), (I = 16 > e ? 16 : e), it === null))
        ...
        if (((e = it), (it = null), (el = 0), R & 6)) throw Error(y(331));
        var l = R;
...
function wd(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    ne === e &&
      (le & n) === n &&
      (q === 4 || (q === 3 && (le & 130023424) === le && 500 > G() - Pi)
        ? Pt(e, 0)
        : (_i |= n)),
    ge(e, t);
}
...
Ja = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || ve.current) me = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (me = !1), sd(e, t, n);
      me = !!(e.flags & 131072);
    }
  else (me = !1), V && t.flags & 1048576 && ta(t, Qr, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      jr(e, t), (e = t.pendingProps);
      var l = rn(t, ae.current);
      en(t, n), (l = ki(null, t, r, e, l, n));
      var o = xi();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Po(t, r, e, n),
            (t = Lo(null, t, r, !0, o, n)))
          : ((t.tag = 0), V && o && si(t), ce(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = sn(Error(y(423)), t)), (t = Tu(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = sn(Error(y(424)), t)), (t = Tu(e, t, r, n, l));
            break e;
          } else
            for (
              ke = ct(t.stateNode.containerInfo.firstChild),
                xe = t,
                V = !0,
                Re = null,
                n = oa(t, null, r, n),
...
function Tr(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Mi(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Zl:
        return (
          (e = Pe(12, n, t, l | 2)), (e.elementType = Zl), (e.lanes = o), e
        );
      case Jl:
        return (e = Pe(13, n, t, l)), (e.elementType = Jl), (e.lanes = o), e;
      case ql:
        return (e = Pe(19, n, t, l)), (e.elementType = ql), (e.lanes = o), e;
      case ss:
        return hl(n, l, o, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ei(t, n | 1), ge(t, G()), !(R & 6) && ((an = G() + 500), wt()));
      }
      break;
    case 13:
      Ft(function () {
...
ws = zi;
ks = Ft;
var zd = { usingClientEntryPoint: !1, Events: [er, Ht, sl, ys, gs, zi] },
  kn = {
  ...
  jd = {
    ...
    findFiberByHostInstance: kn.findFiberByHostInstance || _d,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!kr.isDisabled && kr.supportsFiber)
    try {
      (ll = kr.inject(jd)), (Be = kr);
    } catch {}
}
Ee.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zd;
      ...
      (
        ...
        ee.createElement(
          "svg",
          {
            ...
            className: ["lucide", `lucide-${Td(e)}`, u].join(" "),
            ...c,
          },
          [
            ...t.map(([h, p]) => ee.createElement(h, p)),
            ...(Array.isArray(s) ? s : [s]),
          ],
        ),
    );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Id = be("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function O({ onClick: e, className: t = "", children: n }) {
  return w.jsx("button", {
    onClick: e,
    className: `h-16 rounded-2xl text-white text-xl font-medium transition-colors ${t}`,
    children: n,
  });
}
function Vd({
  ...
  return w.jsx("div", {
    className: "bg-[#1C1C1E] rounded-2xl p-4 mb-4",
    children: w.jsxs("div", {
      ...
      children: [
        w.jsxs("div", {
          ...
          children: [
            w.jsx("span", { className: "text-[#FF9F0A] text-sm", children: r }),
            w.jsxs("div", {
              className: "flex items-center gap-2",
              children: [
                o !== 0 &&
                  w.jsxs("span", {
                    className: "text-[#FF9F0A] text-sm",
                    children: ["M = ", o],
                  }),
                w.jsx("span", {
                  className: "text-[#86868A] text-sm h-6",
                  children: l || (n && `${t} ${n}`),
                }),
              ],
            }),
        ...
        w.jsx("div", {
          className:
            "text-white text-4xl font-light tracking-wider overflow-x-auto whitespace-nowrap",
          children: e,
        }),
      ],
    }),
...
function Hd({ onScientific: e, onConstant: t, onOperation: n, angleUnit: r }) {
  return w.jsxs(w.Fragment, {
    children: [
      w.jsx(O, {
        onClick: () => e("sin"),
        className: "bg-[#505050] hover:bg-[#707070] text-white text-sm",
        children: "sin",
      }),
      w.jsx(O, {
        onClick: () => e("cos"),
...
function Qd({ history: e, onSelect: t, onClear: n }) {
  return w.jsxs("div", {
    className:
      "absolute right-4 top-24 w-80 bg-[#2C2C2E] rounded-2xl p-4 shadow-xl",
    children: [
      w.jsxs("div", {
        ...
        children: [
          ...
          w.jsx("button", {
            onClick: n,
            className: "text-[#86868A] hover:text-[#FF9F0A] transition-colors",
            children: w.jsx(Ad, { className: "w-4 h-4" }),
          }),
        ],
      }),
      w.jsx("div", {
        ...
        children:
          e.length === 0
            ? w.jsx("p", {
                className: "text-[#86868A] text-sm text-center py-4",
            ...
            : e.map((r, l) =>
                w.jsxs(
                  "button",
                  {
                    onClick: () => t(r.result),
                    className:
                      "w-full text-right p-2 rounded hover:bg-[#3A3A3C] transition-colors group",
                    children: [
                      w.jsx("div", {
                        className: "text-[#86868A] text-sm",
                        children: r.expression,
                      }),
                      w.jsx("div", {
                        className:
                          "text-white group-hover:text-[#FF9F0A] transition-colors",
                        children: r.result,
                      }),
                    ],
                  },
...
function Kd() {
  const [e, t] = ee.useState("0"),
    [n, r] = ee.useState(0),
    [l, o] = ee.useState(0),
    [i, u] = ee.useState(null),
    [s, c] = ee.useState(!0);
  ee.useState(!0);
  const [m, h] = ee.useState("DEG"),
    [p, g] = ee.useState([]),
    [k, S] = ee.useState(!1),
    [$, f] = ee.useState(""),
    [a, d] = ee.useState("0");
  ee.useEffect(() => {
    const z = (j) => {
      if (j.key.match(/[0-9.]/)) v(j.key);
      else if (j.key === "Enter") N();
      else if (j.key === "Escape") M();
      else if (j.key === "Backspace") t(e.slice(0, -1) || "0");
      else {
        const D = { "+": "+", "-": "-", "*": "×", "/": "÷", "^": "pow" };
        D[j.key] && x(D[j.key]);
      }
  ...
  const v = (z) => {
    ...
    x = (z) => {
      i && !s && N(), u(z), r(parseFloat(e)), c(!0), f(`${e} ${z}`);
    },
    N = () => {
      ...
      const D = { expression: `${$} = ${j}`, result: j.toString() };
      g([D, ...p.slice(0, 9)]),
        t(j.toString()),
        d(j.toString()),
        u(null),
    ...
    _ = (z) => {
      ...
      let D = 0;
      const Dt = m === "DEG" ? (j * Math.PI) / 180 : j;
      switch (z) {
        case "sin":
          D = Math.sin(Dt);
          break;
      ...
      m === "DEG" &&
        ["asin", "acos", "atan"].includes(z) &&
        (D = (D * 180) / Math.PI);
      const wl = { expression: `${z}(${e}) = ${D}`, result: D.toString() };
      g([wl, ...p.slice(0, 9)]), t(D.toString()), d(D.toString()), c(!0);
    },
    P = (z) => (z < 0 ? NaN : z <= 1 ? 1 : z * P(z - 1)),
    H = (z) => {
      const j = parseFloat(e);
      switch (z) {
        case "MC":
    ...
    M = () => {
      t("0"), r(0), u(null), c(!0), f("");
    };
  return w.jsx("div", {
    className: "min-h-screen bg-[#1C1C1E] flex items-center justify-center p-4",
    children: w.jsxs("div", {
      className: "w-[900px] bg-[#1C1C1E] rounded-3xl p-6 shadow-2xl flex gap-6",
      children: [
        w.jsxs("div", {
          className: "flex-1",
          children: [
            w.jsxs("div", {
              ...
              children: [
                w.jsxs("div", {
                  className: "flex items-center gap-2",
                  children: [
                    w.jsx(Fd, { className: "text-[#FF9F0A] w-8 h-8" }),
                    w.jsx("span", {
                      className: "text-[#FF9F0A] text-sm font-medium",
                      children: "Scientific",
                    }),
                  ],
                }),
                w.jsxs("div", {
                  ...
                  children: [
                    w.jsx("button", {
                      onClick: () => S(!k),
                      className:
                        "text-[#FF9F0A] hover:text-[#FFB340] transition-colors",
                      children: w.jsx(Dd, { className: "w-5 h-5" }),
                    }),
                    w.jsx("button", {
                      onClick: () => h(m === "DEG" ? "RAD" : "DEG"),
                      className:
                        "text-[#FF9F0A] text-sm font-medium hover:text-[#FFB340] transition-colors",
                      children: m,
                    }),
                  ],
                }),
            ...
            w.jsxs("div", {
              ...
              children: [
                w.jsx(O, {
                  onClick: M,
                  className: "bg-[#505050] hover:bg-[#707070] text-white",
                  children: w.jsx(Ud, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: () => t(e.slice(0, -1) || "0"),
                  className: "bg-[#505050] hover:bg-[#707070] text-white",
                  children: w.jsx(Bd, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: () => x("÷"),
                  className: "bg-[#FF9F0A] hover:bg-[#FFB340] text-white",
                  children: w.jsx(Rd, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: () => x("×"),
                  className: "bg-[#FF9F0A] hover:bg-[#FFB340] text-white",
                ...
                [7, 8, 9, 4, 5, 6, 1, 2, 3].map((z) =>
                  w.jsx(
                    O,
                    {
                      onClick: () => v(z.toString()),
                      className: "bg-[#333333] hover:bg-[#505050] text-white",
                      children: z,
                    },
                    z,
                  ),
                ...
                w.jsx(O, {
                  onClick: () => x("-"),
                  className: "bg-[#FF9F0A] hover:bg-[#FFB340] text-white",
                  children: w.jsx(Id, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: () => x("+"),
                  className: "bg-[#FF9F0A] hover:bg-[#FFB340] text-white",
                  children: w.jsx($d, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: N,
                  className:
                    "bg-[#FF9F0A] hover:bg-[#FFB340] text-white row-span-2",
                  children: w.jsx(Od, { className: "w-5 h-5 mx-auto" }),
                }),
                w.jsx(O, {
                  onClick: () => v("0"),
                  className:
                    "col-span-2 bg-[#333333] hover:bg-[#505050] text-white",
                  children: "0",
                }),
                w.jsx(O, {
                  onClick: () => v("."),
...
rc(document.getElementById("root")).render(
  w.jsx(ee.StrictMode, { children: w.jsx(Kd, {}) }),
);
